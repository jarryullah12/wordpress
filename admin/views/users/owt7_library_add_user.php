    ...
    <div class="lms-add-user">
        <div class="page-header">
            ...
            <div class="page-actions">
                <a href="admin.php?page=owt7_library_users&mod=branch&fn=add" class="btn"><?php _e("Add New Branch", "library-management-system"); ?></a>
            ...
            <form class="owt7_lms_user_form" id="owt7_lms_user_form" action="javascript:void(0)" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="user-id"><?php _e("User / Registration ID", "library-management-system"); ?> <span class="required">*</span>  
                            <?php if(isset($params['action']) && in_array($params['action'], ["view", "edit"])){}else{ ?>
                                <a href="javascript:void(0);" data-module="user" id="owt7_btn_ids_auto_generate"><u><?php _e('Auto-generate', 'library-management-system') ?></u>?</a>
                            <?php } ?>
                        </label>
                        <input <?php echo isset($params['action']) && $params['action'] == 'view' ? 'disabled' : ''; ?> value="<?php echo isset($params['user']['u_id']) ? $params['user']['u_id'] : ''; ?>" required type="text" id="owt7_txt_u_id" name="owt7_txt_u_id" <?php if(isset($params['action']) && in_array($params['action'], ["view", "edit"])){ ?>readonly<?php }else{} ?> placeholder="...">
                    </div>
                    <!-- Branch -->
                    <div class="form-group">
                        <label for="branch"><?php _e("Select Branch", "library-management-system"); ?> <span class="required">*</span></label>
                ...
                <div class="form-row">
                    <!-- Name -->
                    <div class="form-group">
                        <label for="owt7_txt_name"><?php _e("Name", "library-management-system"); ?> <span class="required">*</span></label>
                        <input <?php echo isset($params['action']) && $params['action'] == 'view' ? 'disabled' : ''; ?> value="<?php echo isset($params['user']['name']) ? $params['user']['name'] : ''; ?>" required type="text" id="owt7_txt_name" name="owt7_txt_name" placeholder="..." />
                    </div>
                    <!-- Email -->
                    <div class="form-group">
                        <label for="owt7_txt_email"><?php _e("Email", "library-management-system"); ?></label>
                        <input <?php echo isset($params['action']) && $params['action'] == 'view' ? 'disabled' : ''; ?> value="<?php echo isset($params['user']['email']) ? $params['user']['email'] : ''; ?>" type="email" id="owt7_txt_email" name="owt7_txt_email" placeholder="...">
                    </div>
                </div>
                <div class="form-row">
                    <!-- Phone number -->
                    <div class="form-group">
                        <label for="owt7_txt_phone"><?php _e("Phone Number", "library-management-system"); ?></label>
                        <input <?php echo isset($params['action']) && $params['action'] == 'view' ? 'disabled' : ''; ?> value="<?php echo isset($params['user']['phone_no']) ? $params['user']['phone_no'] : ''; ?>" type="text" id="owt7_txt_phone" name="owt7_txt_phone" placeholder="...">
                    </div>
                    <!-- Gender -->
                    <div class="form-group">
                        <label for="owt7_dd_gender"><?php _e("Gender", "library-management-system"); ?></label>
                ...
                <div class="form-row">
                    <!-- Address -->
                    <div class="form-group">
                        <label for="owt7_txt_address"><?php _e("Address", "library-management-system"); ?></label>
                        <input <?php echo isset($params['action']) && $params['action'] == 'view' ? 'disabled' : ''; ?> value="<?php echo isset($params['user']['address_info']) ? $params['user']['address_info'] : ''; ?>" type="text" id="owt7_txt_address" name="owt7_txt_address" placeholder="...">
                    </div>
                    <!-- Status -->
                    <div class="form-group">
                        <label for="owt7_dd_user_status"><?php _e("Status", "library-management-system"); ?> <span class="required">*</span></label>
                ...
                <div class="form-row">
                    <!-- Profile Image -->
                    <div class="form-group">
                        <label for="owt7_profile_image"><?php _e("Profile Image", "library-management-system"); ?></label>
                        ...
                        <?php if(!empty($params['user']['profile_image'])){ ?>
                            <img src="<?php echo $params['user']['profile_image']; ?>" id="owt7_library_image_preview"/>
                        <?php }else{ ?>
                            <img src="<?php echo LIBRARY_MANAGEMENT_SYSTEM_PLUGIN_URL . 'admin/images/default-user-image.png'; ?>" id="owt7_library_image_preview"/>
                        <?php } ?>
                        <input type="hidden" value="<?php echo isset($params['user']['profile_image']) ? $params['user']['profile_image'] : LIBRARY_MANAGEMENT_SYSTEM_PLUGIN_URL . 'admin/images/default-user-image.png'; ?>" name="owt7_profile_image" id="owt7_image_url" />
                    </div>
                </div>
                <?php if(isset($params['action']) && $params['action'] == 'view'){ }else{ ?>                
                    <div class="form-row buttons-group">
