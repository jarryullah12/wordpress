    ...
    <div class="modal-content">
        ...
        <h2>
            <?php if(!empty(get_option( 'owt7_lms_late_fine_currency' ))){ ?>
                <?php _e('Update Late Fine', 'library-management-system'); ?>
            <?php } else { ?>
                <?php _e('Set Late Fine', 'library-management-system'); ?>
            <?php } ?>
        </h2>
        <form class="owt7_lms_form_settings" id="owt7_lms_data_settings" method="post" action="javascript:void(0);">
            ...
            <div class="form-group">
                <label for="owt7_lms_fine_amount"><?php _e('Fine Amount:', 'library-management-system'); ?> <span class="required">*</span></label>
                <input value="<?php echo get_option( 'owt7_lms_late_fine_currency' ); ?>" type="text" id="owt7_lms_fine_amount" name="owt7_lms_fine_amount" class="form-control"
